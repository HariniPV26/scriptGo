                ...
                <div className="w-full max-w-md space-y-8 animate-in fade-in zoom-in-95 duration-700">
                    ...
                    <div className="bg-white rounded-3xl shadow-2xl shadow-slate-900/10 border border-slate-200/60 p-8 sm:p-10 space-y-8">
                        ...
                        <div className="grid grid-cols-2 gap-3">
                            <button className="h-11 px-4 bg-white border-2 border-slate-200 rounded-xl text-sm font-semibold text-slate-700 flex items-center justify-center gap-2 hover:border-slate-300 hover:bg-slate-50 transition-all">
